...
def run_recognition(model_file, window_name):
...
def run_recognition_letters():
    run_recognition(MODEL_FILE_LETTERS, "Letter Sign Language Recognition")

def run_recognition_numbers():
    run_recognition(MODEL_FILE_NUMBERS, "Number Sign Language Recognition")
